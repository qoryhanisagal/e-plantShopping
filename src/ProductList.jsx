...
function ProductList() {
    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                ...
                { 
                    name: "Geraniums", image: "https://cdn.pixabay.com/photo/2012/04/26/21/51/flowerpot-43270_1280.jpg", 
                ...
                { 
                    name: "Catnip", 
                    mage: "https://cdn.pixabay.com/photo/2015/07/02/21/55/cat-829681_1280.jpg", 
    ...
    const handleAddToCart = (plant) => {
        ...
        setAddedToCart((prevAdded) => ({ ...prevAdded, [plant.name]: true }));
    };
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div><a href="#" onClick={handleCartClick} style={styleA}><h1 className='cart'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" height="68" width="68"><circle cx="80" cy="216" r="12"></circle><circle cx="184" cy="216" r="12"></circle><path d="M42.3,72H221.7l-26.4,92.4A15.9,15.9,0,0,1,179.9,176H84.1a15.9,15.9,0,0,1-15.4-11.6L32.5,37.8A8,8,0,0,0,24.8,32H8" fill="none" stroke="#faf9f9" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg></h1></a></div>
                </div>
            </div>
            {!showCart ? (
