...
const CartItem = ({ onContinueShopping }) => {
  ...
  const handleContinueShopping = (e) => {
    e.preventDefault();
    onContinueShopping(); // Trigger the parent component’s function to go back to the products page
  };
  ...
  // Handle decrement of item quantity with conditional removal if quantity is 1
